...
public class SpringFoxSwagger {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Banco Backend API",
                "API para el manejo de la seleccion de tarjertas de credito de acuerdo al cliente",
                "V1",
                "Terminos del servicio",
                new Contact("Diego Ortiz / Leonel Sosa", "www.google.com", "diegocarranza@ibm.com / leonelvs@ibm.com"),
